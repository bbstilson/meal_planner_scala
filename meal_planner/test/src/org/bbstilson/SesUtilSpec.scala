...
class SesUtilSpec extends AnyFlatSpec with Matchers {
  "mkBody" should "properly format the message body" in {
    ...
    SesUtil.mkBody(meals) shouldBe expectedBody
  }

  "mkSubject" should "make a propertly formatted subject" in {}
